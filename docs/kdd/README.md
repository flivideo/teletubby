...
| [006](decisions/adr-006-an-agent-may-choose-the-stage-only-while-the-talent-is-idle.md) | An agent may choose what is on stage — only while the talent is not on the prompter | accepted |
